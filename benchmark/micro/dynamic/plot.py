...
plt.figure(1)
grift_data = np.genfromtxt('output/ref-grift.csv'
                               , delimiter=','
...
if latex_output:
    plt.savefig('output/grift_vs_gambit_refreadwrite_dyn1', bbox_inches='tight')
else:
    plt.show()
...
if latex_output:
    plt.savefig('output/grift_vs_gambit_refreadwrite_dyn2', bbox_inches='tight')
else:
    plt.show()
