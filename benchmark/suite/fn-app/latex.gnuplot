...
plot inFile index 0 u 1:2:3 t "Function Representation using Twosomes" w errorbars lw 2 ,\
     inFile index 1 u 1:2:3 t "Hybrid Representation using Coercions"  w errorbars lw 2
